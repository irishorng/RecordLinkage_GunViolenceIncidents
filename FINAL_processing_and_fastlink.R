...
################################################################################
saveRDS(set1, "GVA_cleaned3.RDS")
saveRDS(set2, "NVDRS_cleaned3.RDS")

write.csv(set1, "GVA_cleaned3.csv", row.names=FALSE)
write.csv(set2, "NVDRS_cleaned3.csv", row.names=FALSE)
...
set1_sub <-readRDS("NVDRS_cleaned3.RDS")
set2_sub <-readRDS("GVA_cleaned3.RDS")
...
################################## testing a single block , don't include this in final draft
set1_block40 <- set1_sub[blockstate_out$block.40$dfA.inds,]
set2_block40 <- set2_sub[blockstate_out$block.40$dfB.inds,]
fl_out_block40 <- fastLink(
  set1_block40, set2_block40,
